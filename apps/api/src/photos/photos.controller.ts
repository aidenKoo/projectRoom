...
export class PhotosController {
  ...
  @Post()
  @ApiOperation({ summary: 'Upload a new photo (after Firebase Storage upload)' })
  ...
  @ApiQuery({ name: 'me', required: false, description: 'Set to 1 to get own photos' })
  @ApiQuery({ name: 'userId', required: false, description: 'Get photos of specific user' })
  async findAll(
    @Request() req,
    @Query('me') me?: string,

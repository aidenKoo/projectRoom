import { IsInt, IsString, IsArray, IsOptional, Min, Max, ValidateNested, IsNumber } from 'class-validator';
...
export class CreatePreferenceDto {
  ...
  @ApiPropertyOptional({ description: 'Acceptable religions (comma-separated)', example: 'Christian,Buddhist,None' })
  @IsString()
  @IsOptional()
  religionOk?: string;

  @ApiPropertyOptional({ description: 'Acceptable drinking habits (comma-separated)', example: 'Social,Never' })
  @IsString()
  @IsOptional()
  drinkOk?: string;

  @ApiPropertyOptional({ description: 'Acceptable smoking habits (comma-separated)', example: 'Never' })
  @IsString()
  @IsOptional()
  smokeOk?: string;
  ...
  @ApiPropertyOptional({ description: 'Tags to include', example: ['fitness', 'travel'] })
  @IsArray()
  @IsOptional()
  tagsInclude?: string[];
